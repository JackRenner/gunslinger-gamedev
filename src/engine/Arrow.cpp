...
Arrow::Arrow(Player* sayu) : AnimatedSprite("Arrow"){
	this->type = "Arrow";
	this->sayu = sayu;
...
void Arrow::update(set<SDL_Scancode> pressedKeys){
...
void Arrow::onMeleeStrike(){
	this->health -= 10;
	if(this->health < 0) this->health = 0;
}

// void Arrow::onEssenceStrike(Weapon* w){

// 	if(this->shield <= 0) this->health -= w->damage;
// 	if(this->health < 0) this->health = 0;
// }

// void Arrow::onCollision(DisplayObject* other){
...
void Arrow::save(ofstream &out){
	//Sprite::save(out);
	//TODO: ADD THIS TO SAVE Arrow DATA
}


void Arrow::setPatrolRange(){
